...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		if (request.getSession().getAttribute("usuario") == null) {
			...
			request.getRequestDispatcher("views/nuevoProducto.jsp").forward(request, response);
		}
...
//		                System.out.println(fieldValue);
		        ...
		        ProductoVO producto = new ProductoVO(0, usuario.getId(), nombre, descripcion, categoriaId, precio, impuesto,
		        		img, baja);
